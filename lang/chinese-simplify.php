...
$_LANG['store']['sitelock']['plansAndPricing'] = "计划 & 价格";
$_LANG['store']['sitelock']['featuresLink'] = "特性";
$_LANG['store']['sitelock']['websiteHacked'] = "网站被骇入？";
$_LANG['store']['sitelock']['faq'] = "FAQ";
$_LANG['store']['sitelock']['contentHeadline'] = "网站安全 & 保护您的网站免受病毒侵袭";
$_LANG['store']['sitelock']['contentBodyParagraph1'] = "SiteLock&trade;, 网站安全的国际领先者，保护您的站点以为您带来您更多的安心。";
$_LANG['store']['sitelock']['contentBodyParagraph2'] = "SiteLock的每日恶意软件扫描识别漏洞和已知的恶意代码，并自动删除它从您的网站，以保护您的网站和访问者对威胁。";
$_LANG['store']['sitelock']['contentBodyParagraph3'] = "另外，你得到的SiteLock信任印章，建立客户的信心，被证明是增加销售和转换率。";
$_LANG['store']['sitelock']['comparePlans'] = "比较SiteLock计划";
$_LANG['store']['sitelock']['comparePlansSubtitle']="您网站的专业安全功能";
$_LANG['store']['sitelock']['featuresTitle'] = "SiteLock功能";
$_LANG['store']['sitelock']['featuresHeadline'] = "提供一系列旨在保护您的网站和您的企业声誉的功能：";
$_LANG['store']['sitelock']['featuresMalwareTitle'] = "Malware Scan";;
$_LANG['store']['sitelock']['featuresMalwareContent'] = "主动监控并提醒您在您的网站上检测到的任何恶意软件";
$_LANG['store']['sitelock']['featuresMalwareRemovalTitle'] = "自动清除恶意软件";
$_LANG['store']['sitelock']['featuresMalwareRemovalContent'] = "如果扫描发现任何东西，SiteLock将安全地自动删除任何已知的恶意软件。";
$_LANG['store']['sitelock']['featuresVulnerabilityTitle'] = "漏洞扫描";
$_LANG['store']['sitelock']['featuresVulnerabilityContent'] = "自动检查您的应用程序，以确保它们是最新的，并对已知的漏洞进行安全保护。";
$_LANG['store']['sitelock']['featuresOWASPTitle'] = "OWASP保护";
$_LANG['store']['sitelock']['featuresOWASPContent'] = "获得OWASP（开放网络应用安全项目）认可的十大网络应用安全漏洞的保护";
$_LANG['store']['sitelock']['featuresTrustSealTitle'] = "SiteLock&trade; 信任标记";
$_LANG['store']['sitelock']['featuresTrustSealContent'] = "通过显示您的网站受到SiteLock的保护，给您的访问者增加信心";
$_LANG['store']['sitelock']['featuresFirewallTitle'] = "防火墙";
$_LANG['store']['sitelock']['featuresFirewallContent'] = "TrueShield&trade; Web应用程序防火墙保护您的网站免受黑客和攻击";
$_LANG['store']['sitelock']['featuresReputationTitle'] = "保护您的声誉";
$_LANG['store']['sitelock']['featuresReputationContent'] = "每日扫描有助于在搜索引擎有机会发现恶意软件并将其列入您的网站的黑名单之前，及早发现恶意软件";
$_LANG['store']['sitelock']['featuresSetupTitle'] = "快速自动设置";
$_LANG['store']['sitelock']['featuresSetupContent'] = "即时和全自动的设置让您无需安装任何东西就能立即获得保护";
$_LANG['store']['sitelock']['featuresCDNTitle'] = "内容传输网络（CDN）";
$_LANG['store']['sitelock']['featuresCDNContent'] = "通过在全球范围内发布网站内容，并从最近的地点向访问者提供服务，以加快页面加载速度，无论他们身在何处，都能加快网站速度。";
$_LANG['store']['sitelock']['emergencyPlanTitle'] = "网站被黑了？";
$_LANG['store']['sitelock']['emergencyPlanHeadline'] = "用SiteLock应急响应立即修复";
$_LANG['store']['sitelock']['emergencyPlanBody'] = "如果您的网站被攻击和入侵，请立即获得紧急援助，快速恢复您的网站。以下是SiteLock应急响应如何帮助：";;
$_LANG['store']['sitelock']['emergencyPlanResponseTitle'] = "立即响应";
$_LANG['store']['sitelock']['emergencyPlanResponseContent'] = "通过分析获得我们最快的响应时间，并在30分钟内开始恢复您的网站。";
$_LANG['store']['sitelock']['emergencyPlanMalwareTitle'] = "彻底清除恶意软件";
$_LANG['store']['sitelock']['emergencyPlanMalwareContent'] = "如果我们的自动技术无法清除恶意内容，我们将进行手动清理。";
$_LANG['store']['sitelock']['emergencyPlanPriorityTitle'] = "优先处理";
$_LANG['store']['sitelock']['emergencyPlanPriorityContent'] = "有了急救包，你就能快速进入队列的最前面。";
$_LANG['store']['sitelock']['emergencyPlanAftercareTitle'] = "7天后护理";
$_LANG['store']['sitelock']['emergencyPlanAftercareContent'] = "我们将继续监控您的网站7天，以确保您的网站在恢复后没有恶意软件。";
$_LANG['store']['sitelock']['emergencyPlanUpdatesTitle'] = "实时更新";
$_LANG['store']['sitelock']['emergencyPlanAftercareContent'] = "在清理和恢复您的网站的整个过程中，通过我们的实时更新跟踪进展情况。";
$_LANG['store']['sitelock']['emergencyPlanPaymentTitle'] = "一次付款";
$_LANG['store']['sitelock']['emergencyPlanPaymentContent'] = "紧急服务只需一次付费，无需经常性费用或订阅。";
$_LANG['store']['sitelock']['emergencyPlanOnlyCost'] = "7天的保护仅需 :price";
$_LANG['store']['sitelock']['buyNow'] = "立刻购买";
$_LANG['store']['sitelock']['faqTitle'] = "常见问题";
$_LANG['store']['sitelock']['faqOneTitle'] = "SiteLock是什么？";
$_LANG['store']['sitelock']['faqOneBody'] = "SiteLock为所有规模的网站提供简单，快速和负担得起的网站安全。公司成立于2008年，保护着全球超过1200万个网站。SiteLock基于云计算的产品套件提供自动网站漏洞检测和恶意软件清除、DDoS保护、网站加速、网站风险评估和PCI合规。";
$_LANG['store']['sitelock']['faqOneBodyLearnMore'] = "您可以通过 :learnMoreLink 来阅读更多与SiteLock相关的内容。";
$_LANG['store']['sitelock']['faqOneBodyLearnLinkText'] = "单击此处以观看 'SiteLock 如何工作' 的视频";
$_LANG['store']['sitelock']['faqTwoTitle'] = "SiteLock是做什么的？";
$_LANG['store']['sitelock']['faqTwoBody'] = "SiteLock提供全面的网站安全。它执行网站的日常扫描，以确定漏洞或恶意软件。当发现漏洞或恶意软件时，您将立即得到提醒。根据您的SiteLock扫描仪，它会自动删除任何恶意软件在您的网站上。 对于内容管理系统（CMS）网站，SiteLock可以自动修补发现的漏洞。";
...
$_LANG['store']['sitelock']['faqThreeBodyList1'] = "SiteLock每天都会对网站的文件进行恶意软件扫描。如果发现恶意软件，网站所有者会立即得到提醒。SiteLock还提供全面的扫描，以自动删除恶意软件。";
$_LANG['store']['sitelock']['faqThreeBodyList2Title'] = "漏洞扫描";
$_LANG['store']['sitelock']['faqThreeBodyList2'] = "SiteLock会对网站应用程序进行扫描，以找出可能导致泄密的常见漏洞。";
$_LANG['store']['sitelock']['faqThreeBodyList3Title'] = "应用程序安全和漏洞修补";
$_LANG['store']['sitelock']['faqThreeBodyList3'] = "SiteLock拥有自动修补内容管理系统(CMS)漏洞的技术";
$_LANG['store']['sitelock']['faqFourTitle'] = "什么是漏洞和恶意软件？";
$_LANG['store']['sitelock']['faqFourBodyParagraph1'] = ":vulnerabilityStrong 指的是网站或网络应用程序代码中的弱点或错误配置，允许攻击者获得某种程度的网站控制权，并可能控制托管服务器。大多数漏洞都是通过自动化手段，如漏洞扫描器和僵尸网络来利用的。";
$_LANG['store']['sitelock']['websiteVulnerability'] = "网站漏洞";
$_LANG['store']['sitelock']['faqFourBodyParagraph2'] = ":malwareStrong ，简称为恶意软件，用于收集敏感数据，未经授权访问网站，甚至劫持电脑。";
$_LANG['store']['sitelock']['malware'] = "病毒";
$_LANG['store']['sitelock']['faqFiveTitle'] = "SiteLock会影响网站性能吗？";
$_LANG['store']['sitelock']['faqFiveBody'] = "不会。在网站扫描期间，SiteLock下载相关文件到一个安全的服务器，并执行扫描。不会影响到网站内容，代码，带宽或网站上的服务器资源。";
$_LANG['store']['sitelock']['faqSixTitle'] = "什么是SiteLock信任标记？";
$_LANG['store']['sitelock']['faqSixBody'] = "SiteLock信任标记是一个广泛认可的安全徽章，您可以在您的网站上显示。这是一个明确的指示，您的网站是安全的，没有恶意软件。要添加密封到您的网站，只需包括代码片段，SiteLock提供在您的网站的页脚区域。";
...
$_LANG['goCardless']['paymentPending'] = "一个付款请求已经提交，将于 :date 向您的银行发起结算。<br>当银行结算发生时，一份支付确认邮件将被发送。";
$_LANG['goCardless']['automaticPayment'] = "此账号已经设定一个自动支付方案，无需进行手动支付。";

$_LANG['contactDetails'] = "联系方式";
$_LANG['createNewSupportRequest'] = "创建一个新的请求支持";

$_LANG['nonotifications'] = "木有通知哦";
$_LANG['apply'] = "应用";
$_LANG['admin']['returnToAdmin'] = "回到管理区域";
$_LANG['searchOurKnowledgebase'] = "查询我们的帮助中心";
$_LANG['browseProducts'] = "浏览产品";
$_LANG['secureYourDomain'] = "现在注册来确保您心仪域名的安全";
$_LANG['secureYourDomainShort'] = "保护您的域名";
$_LANG['transferYourDomain'] = "转移您的域名";
$_LANG['transferExtend'] = "现在转移并延长一年有效期";
$_LANG['howCanWeHelp'] = "今天我们能帮您什么呢";
$_LANG['homepage']['submitTicket'] = "提交工单";
$_LANG['homepage']['manageServices'] = "管理服务";
$_LANG['homepage']['manageDomains'] = "管理域名";
$_LANG['homepage']['supportRequests'] = "帮助请求";
...
$_LANG['userLogin']['signInToContinue'] = "登录您的账户以继续";

$_LANG['networkIssues']['scheduled'] = "有 :count 个预计的网络维护问题。";
$_LANG['networkIssues']['http'] = "HTTP";
$_LANG['networkIssues']['ftp'] = "FTP";
$_LANG['networkIssues']['pop3'] = "POP3";
$_LANG['networkIssues']['affectingYou'] = "这个问题影响的服务器可能会影响到您的服务";

$_LANG['chooseFile'] = "选择文件";
$_LANG['support']['postedBy'] = "由 :name 于 :date 发布 :requestorType";

$_LANG['requestor'] = "请求者";

$_LANG['facebook']['notAuthorized'] = "你没有授权使用Facebook进行认证。我们恐怕无法用它来让您登录。";

////////// End of simplified chinese language file.  Do not place any translation strings below this line!
